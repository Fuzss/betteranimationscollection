...
public class LayerAnimatedSnowmanHeadStick implements LayerRenderer<EntitySnowman>
{
    private final RenderAnimatedSnowManStick snowManRenderer;

    public LayerAnimatedSnowmanHeadStick(RenderAnimatedSnowManStick snowManRendererIn)
    {

...
@OnlyIn(Dist.CLIENT)
public class MooshroomUdderMushroomLayer<T extends MooshroomEntity> extends LayerRenderer<T, MooshroomUdderModel<T>> {
   public MooshroomUdderMushroomLayer(IEntityRenderer<T, MooshroomUdderModel<T>> p_i50931_1_) {
      super(p_i50931_1_);
   }

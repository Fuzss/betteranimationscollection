...
public class LayerFlailingEndermanEyes implements LayerRenderer<EntityEnderman>
{
    ...
    public LayerFlailingEndermanEyes(RenderFlailingEnderman endermanRendererIn)
    {

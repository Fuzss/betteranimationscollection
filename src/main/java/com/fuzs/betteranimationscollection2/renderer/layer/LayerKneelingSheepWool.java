...
import com.fuzs.betteranimationscollection2.renderer.model.ModelKneelingSheep1;
...
public class LayerKneelingSheepWool implements LayerRenderer<EntitySheep>
{
    private static final ResourceLocation TEXTURE = new ResourceLocation("textures/entity/sheep/sheep_fur.png");
    private final RenderKneelingSheep sheepRenderer;
    private final ModelKneelingSheep1 sheepModel = new ModelKneelingSheep1();

    public LayerKneelingSheepWool(RenderKneelingSheep sheepRendererIn)
    {

...
@OnlyIn(Dist.CLIENT)
public class AnimatedSnowmanStickHeadLayer extends LayerRenderer<SnowGolemEntity, AnimatedSnowManStickModel<SnowGolemEntity>> {
   public AnimatedSnowmanStickHeadLayer(IEntityRenderer<SnowGolemEntity, AnimatedSnowManStickModel<SnowGolemEntity>> p_i50922_1_) {
      super(p_i50922_1_);
   }

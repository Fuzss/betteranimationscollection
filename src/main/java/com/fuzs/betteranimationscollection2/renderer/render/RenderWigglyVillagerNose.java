...
import com.fuzs.betteranimationscollection2.renderer.model.ModelWigglyVillagerNose;
...
public class RenderWigglyVillagerNose extends RenderLiving<EntityVillager>
{
    ...
    public RenderWigglyVillagerNose(RenderManager renderManagerIn)
    {
        super(renderManagerIn, new ModelWigglyVillagerNose(0.0F), 0.5F);
        this.addLayer(new LayerCustomHead(this.getMainModel().villagerHead));
    }

    public ModelWigglyVillagerNose getMainModel()
    {
        return (ModelWigglyVillagerNose)super.getMainModel();
    }

...
import com.fuzs.betteranimationscollection2.renderer.model.ModelGhastTentacles;
...
public class RenderGhastTentacles extends RenderLiving<EntityGhast>
{
    ...
    public RenderGhastTentacles(RenderManager renderManagerIn)
    {
        super(renderManagerIn, new ModelGhastTentacles(), 0.5F);
    }

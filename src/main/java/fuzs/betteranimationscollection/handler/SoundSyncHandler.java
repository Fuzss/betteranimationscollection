//package fuzs.betteranimationscollection.handler;
//
...
//        put(SoundEvents.PIG_AMBIENT, EntityType.PIG);
//        put(SoundEvents.VILLAGER_AMBIENT, EntityType.VILLAGER);
//        put(SoundEvents.CHICKEN_AMBIENT, EntityType.CHICKEN);
//        put(SoundEvents.SNOW_GOLEM_SHOOT, EntityType.SNOW_GOLEM);
//    }};
//    /**
...
//                if (comparePosition.test(entity.getPosX(), soundIn.getX()) && comparePosition.test(entity.getY(), soundIn.getY())

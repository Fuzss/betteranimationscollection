...
public class SyncSoundElement extends AbstractElement implements IClientElement, ISoundEventListener {
    ...
    public void setupClientConfig(OptionsBuilder builder) {
        ...
        builder.define("Sound Detection Range", 0.5).min(0.0).max(8.0).comment("Range in blocks for the sound detection system to look for a mob that made a certain sound. Setting this to 0 will prevent all sound based animations.").sync(v -> this.soundRange = v);
    }

...
public class ModelSpiderKnees extends ModelBase
{
    ...
    public ModelSpiderKnees()
    {
        ...
        this.spiderHead.addBox(-4.0F, -4.0F, -8.0F, 8, 8, 8);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        this.spiderLeg1.rotateAngleZ += f7 + 0.675F;
        this.spiderLeg2.rotateAngleZ += -f7 - 0.675F;
        this.spiderLeg3.rotateAngleZ += f8 + 0.675F;
        this.spiderLeg4.rotateAngleZ += -f8 - 0.675F;
        this.spiderLeg5.rotateAngleZ += f9 + 0.675F;
        this.spiderLeg6.rotateAngleZ += -f9 - 0.675F;
        this.spiderLeg7.rotateAngleZ += f10 + 0.675F;
        this.spiderLeg8.rotateAngleZ += -f10 - 0.675F;
    }
}
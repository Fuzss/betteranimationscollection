...
import fuzs.tbac2.render.RenderMooshroomUdder;
...
public class LayerMooshroomUdderMushroom implements LayerRenderer<EntityMooshroom>
{
    private final RenderMooshroomUdder mooshroomRenderer;

    public LayerMooshroomUdderMushroom(RenderMooshroomUdder mooshroomRendererIn)
    {
